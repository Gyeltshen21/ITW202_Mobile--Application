...
public class AdminProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sCode = schoolCode;
        databaseReference = FirebaseDatabase.getInstance().getReference("SMSadmin");
        ...
        checkUser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    StorageReference storageReference = FirebaseStorage.getInstance().getReference("SMSadmin/"+sCode+"/image.jpg");
    ...
    private void UploadFile() {
        ...
        if(adminImageUri != null){
            final StorageReference fileReference = FirebaseStorage.getInstance().getReference("SMSadmin/"+sCode+"/image.jpg");
