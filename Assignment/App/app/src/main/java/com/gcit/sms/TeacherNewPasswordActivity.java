...
public class TeacherNewPasswordActivity extends AppCompatActivity {

    TextInputLayout editTextPassword, editTextConfirmPassword;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_teacher_new_password);
    ...
    public void updateNewPassword(View view) {
        ...
        if(!validatePassword()){
            ...
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("SMSemployee");
            reference.child(schoolCode).child("password").setValue(_newPassword);
            Intent intent = new Intent(TeacherNewPasswordActivity.this, UpdatedForgotPasswordActivity.class);
